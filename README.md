...
- Estimate the number of packs needed
- Compare Fast Method vs Slow Method costs
- Simple and quick calculations for leveling plans

## How It Works

Enter your current level and target level, and the bot will:

1. Calculate the total XP needed
